...
def cli():
    ...
    parser.add_argument("--batch_size", default=1, type=int, help="the preferred batch size for inference")
    ...
    parser.add_argument("--compression_ratio_threshold", type=optional_float, default=2.8, help="if the gzip compression ratio is higher than this value, treat the decoding as failed")
    parser.add_argument("--logprob_threshold", type=optional_float, default=-2.5, help="if the average log probability is lower than this value, treat the decoding as failed")
